...
languages_data = [
  ...
  { name: "JS", image_url: "https://s1.qwant.com/thumbr/474x537/2/c/d82cdca3fb3b80cba6bb24abea30944e80209a2b6f23318ceb4e83cc7ac9e2/th.jpg?u=https%3A%2F%2Ftse.mm.bing.net%2Fth%3Fid%3DOIP.eQRqVTzi6ep_wZku3iDmEAHaIZ%26pid%3DApi&q=0&b=1&p=0&a=0" },
  ...
  { name: "PHP", image_url: "https://s2.qwant.com/thumbr/474x540/c/9/000356f8bb5ce3034c805a76799f24a768e7f69af008d22d0d90cf1b0269b9/th.jpg?u=https%3A%2F%2Ftse.mm.bing.net%2Fth%3Fid%3DOIP.aH7gPR6VJmqQiRXQZ4GvxwHaIc%26pid%3DApi&q=0&b=1&p=0&a=0" },
...
arenas_data = [
  { name: "ESL_master", description: "test", start_date: "2024-09-07", end_date: "2024-10-12", image_url: languages.find { |lang| lang.name == "Ruby" }.image_url, user_id: users.find { |u| u.pseudo == "victorcariou1" }.id, prize: 100, active: true, language_id: languages.find { |lang| lang.name == "Ruby" }.id, category_id: categories.find { |cat| cat.name == "Débutant" }.id },
  { name: "Code_Coliseum", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 250, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermédiaire" }.id },
  { name: "Debugging_Dome", description: "test", start_date: "2024-10-26", end_date: "2024-11-30", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 175, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Expert" }.id },
  { name: "Byte_Battlefield", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Débutant" }.id },
  { name: "Algorithm_Arena", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 100, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermédiaire" }.id },
  { name: "Syntax_Stadium", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 150, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Expert" }.id },
  { name: "Compile_Coliseum", description: "test", start_date: "2024-10-26", end_date: "2024-11-30", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 125, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Débutant" }.id },
  { name: "Hacker_Hall", description: "test", start_date: "2024-10-26", end_date: "2024-11-30", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 150, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermédiaire" }.id },
  { name: "Logic_Lair", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Expert" }.id },
  { name: "Terminal_Tower", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 125, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Débutant" }.id },
  { name: "Function_Forum", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 150, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermédiaire" }.id },
  { name: "Script_Sanctuary", description: "test", start_date: "2024-10-26", end_date: "2024-11-30", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Expert" }.id },
  { name: "Variable_Vault", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 375, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Débutant" }.id },
  { name: "Pixel_Pit", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 125, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermédiaire" }.id },
  { name: "Data_Den", description: "test", start_date: "2024-10-26", end_date: "2024-11-30", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Expert" }.id },
  { name: "Query_Quadrant", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 100, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Débutant" }.id },
  { name: "Binary_Bastion", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermédiaire" }.id },
  { name: "Stack_Fortress", description: "test", start_date: "2024-10-26", end_date: "2024-11-30", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 500, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Expert" }.id },
  { name: "Module_Maze", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Débutant" }.id },
  { name: "Protocol_Plaza", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 250, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermédiaire" }.id },
  { name: "Code_Clash_Court", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, prize: 625, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Expert" }.id }
]
