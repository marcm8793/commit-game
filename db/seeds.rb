...
arenas_data = [
  ...
  { name: "Code_Coliseum", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 10, prize: 250, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermediate 🟠" }.id },
  ...
  { name: "Byte_Battlefield", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 8, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Beginner 🟢" }.id },
  { name: "Algorithm_Arena", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 4, prize: 100, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermediate 🟠" }.id },
  ...
  { name: "Compile_Coliseum", description: "test", start_date: "2024-10-26", end_date: "2024-11-30", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 5, prize: 125, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Beginner 🟢" }.id },
  { name: "Hacker_Hall", description: "test", start_date: "2024-10-26", end_date: "2024-11-30", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 6, prize: 150, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermediate 🟠" }.id },
  ...
  { name: "Terminal_Tower", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 5, prize: 125, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Beginner 🟢" }.id },
  { name: "Function_Forum", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 6, prize: 150, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermediate 🟠" }.id },
  ...
  { name: "Variable_Vault", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 15, prize: 375, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Beginner 🟢" }.id },
  { name: "Pixel_Pit", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 5, prize: 125, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermediate 🟠" }.id },
  ...
  { name: "Query_Quadrant", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 4, prize: 100, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Beginner 🟢" }.id },
  { name: "Binary_Bastion", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 8, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermediate 🟠" }.id },
  ...
  { name: "Module_Maze", description: "test", start_date: "2024-10-19", end_date: "2024-11-23", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 8, prize: 200, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Beginner 🟢" }.id },
  { name: "Protocol_Plaza", description: "test", start_date: "2024-11-02", end_date: "2024-12-07", image_url: languages.sample.image_url, user_id: users.sample.id, slots: 10, prize: 250, active: false, language_id: languages.sample.id, category_id: categories.find { |cat| cat.name == "Intermediate 🟠" }.id },
